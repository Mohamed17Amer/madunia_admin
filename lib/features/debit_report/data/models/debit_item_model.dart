...
class DebitItem {
  ...
  /// Create DebitItem from Firestore document
  ...
  /// Convert DebitItem to Map for Firestore
  ...
  @override
  String toString() {
    return 'DebitItem(id: $id, recordName: $recordName, recordMoneyValue: $recordMoneyValue, status: $status, createdAt: $createdAt)';
  }
