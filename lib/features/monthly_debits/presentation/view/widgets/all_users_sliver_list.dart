...
class AllUsersSliverListForMonthlyTransactions extends StatelessWidget {
  final List<AppUser> users;
  const AllUsersSliverListForMonthlyTransactions({super.key, required this.users});
      ...
      builder: (context, state) {
        return SliverList.separated(
          itemBuilder: (BuildContext context, int index) {
            return UsersSliverListItemTransactions(user: users[index]);
          },
